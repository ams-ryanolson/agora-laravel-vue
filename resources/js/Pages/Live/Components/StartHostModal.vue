                        ...
                        <DialogPanel
                            ...
                            <div class="flex flex-col">
                                <div class="text-center flex justify-center items-center">
                                    <DialogTitle class="text-2xl leading-6 font-medium text-gray-100">
                                        Start a stream
                                    </DialogTitle>
                                </div>
                                <div class="text-gray-400 text-center pt-4 flex flex-col gap-3 font-medium">
                                    <span>Setup your stream how you want it to be, then click Start Stream. Once you do, you will be joinable by your profile, FanTV list, your activity wall, or if someone shares your stream.</span>
                                    <span class="text-gray-300">You must have verified your identity and added payout details before you can start streaming live</span>
                                </div>
                            </div>
                            <form @click.prevent class="mt-6">
                                <div class="flex flex-col gap-3">
                                    ...
                                    <Menu as="div" class="relative inline-block text-left">
                                        <div>
                                            <MenuButton
                                                ...
                                                {{ form.privacy ? form.privacy : 'Select Audience' }}
                                            ...
                                            <MenuItems
                                                ...
                                                <div class="py-1 space-y-2">
                                                    <MenuItem v-slot="{ active }">
                                                        <a href="#"
                                                           @click="selectPrivacy('Everyone')"
                                                           :class="[active ? 'bg-sky-600 text-gray-100' : 'text-gray-100', 'block px-4 py-2 text-center']">Everyone</a>
                                                    </MenuItem>
                                                    <MenuItem v-slot="{ active }">
                                                        <a href="#"
                                                              @click="selectPrivacy('Followers')"
                                                           :class="[active ? 'bg-sky-600 text-gray-100' : 'text-gray-100', 'block px-4 py-2 text-center']">Followers</a>
                                                    </MenuItem>
                                                    <MenuItem v-slot="{ active }">
                                                        <a href="#"
                                                                @click="selectPrivacy('Subscribers')"
                                                           :class="[active ? 'bg-sky-600 text-gray-100' : 'text-gray-100', 'block px-4 py-2 text-center']">Subscribers</a>
                                                    </MenuItem>
                                                </div>
                                            </MenuItems>
                                        </transition>
                                    ...
                                    <div class="col-span-full">
                                        ...
                                        <div v-if="form.coverPhoto">
                                            <img :src="form.coverPhoto" alt="image" class="w-full h-48 object-cover rounded-lg"/>
                                        </div>
                                    </div>

                                    <div class="w-full flex flex-row gap-6 justify-between items-center">
                                        <button @click="submit" class="w-full rounded-lg bg-sky-500 hover:bg-sky-600 px-4 py-2 mt-6 font-medium text-white">
                                            Start stream
                                        </button>
                                        <button @click="cancel"
