  ...
  <ChooseDevices
    ...
    >
        ...
        >
            ...
            >
                <div  id="remote-player" style="display:contents;"  class="w-full h-full rounded-lg">                
                </div>


            <div  v-if="hasPermissionToGoLive"
        ...
        <div class="xs:hidden md:block col-span-3 h-screen p-3">
            ...
            >
                ...
                >
                    <ViewerChat ref="rtmChat" @sysMessage="sysMessage" :channelId="page.props.channelId" />
                </div>
            </div>
        </div>
    </div>
